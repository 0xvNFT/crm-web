...
export type OpportunityProduct       = components['schemas']['OpportunityProductResponse']
export type AddOpportunityProductRequest    = components['schemas']['AddOpportunityProductRequest']
export type UpdateOpportunityProductRequest = components['schemas']['UpdateOpportunityProductRequest']
