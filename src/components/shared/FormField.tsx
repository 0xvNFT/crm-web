...
/**
 * Convenience wrapper for simple native-input fields (label + input + error + optional hint).
 * Use in auth pages and any form where the input is not controlled by a library (Select, Combobox).
 * For Controller-wrapped fields, use FormRow instead.
 */
